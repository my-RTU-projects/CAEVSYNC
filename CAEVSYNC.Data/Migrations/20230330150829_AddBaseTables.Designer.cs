...
namespace CAEVSYNC.API.Data.Migrations
{
    ...
    [Migration("20230330150829_AddBaseTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.AccountToCalendarConnection", b =>
                {
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.Calendar", b =>
                {
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.CalendarToEventConnection", b =>
                {
                    b.Property<string>("CalendarId")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.ConnectedAccount", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.Event", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.SyncedEventData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.UserToAccountConnection", b =>
                {
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.AccountToCalendarConnection", b =>
                {
                    b.HasOne("CAEVSYNC.Api.Data.Entities.ConnectedAccount", "Account")
                        .WithMany()
                        .HasForeignKey("AccountId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CAEVSYNC.Api.Data.Entities.Calendar", "Calendar")
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.CalendarToEventConnection", b =>
                {
                    ...
                    b.HasOne("CAEVSYNC.Api.Data.Entities.Event", "Event")
                        .WithMany("CalendarToEventConnections")
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.SyncedEventData", b =>
                {
                    b.HasOne("CAEVSYNC.Api.Data.Entities.Calendar", "OriginCalendar")
                        .WithMany()
                        .HasForeignKey("OriginCalendarId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CAEVSYNC.Api.Data.Entities.Calendar", "TargetCalendar")
                        .WithMany()
            ...
            modelBuilder.Entity("CAEVSYNC.Api.Data.Entities.UserToAccountConnection", b =>
                {
                    b.HasOne("CAEVSYNC.Api.Data.Entities.ConnectedAccount", "ConnectedAccount")
                        .WithMany()
